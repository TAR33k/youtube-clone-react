  ...
  return (
    <div className="play-video">
      ...
      <div className="vid-description">
        <p>
          {apiData
            ? apiData.snippet.description.length > 250 && !isFullDescription
        ...
        {apiData?.snippet.description.length > 250 && (
          <p
            style={{ color: "#5a5a5a", fontWeight: 600, cursor: "pointer" }}
            onClick={() =>
              setIsFullDescription((prev) => (prev === false ? true : false))
            }
          >
